...
SonAni_Wait:	dc.b   5,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand,  frS_Stand
		...
		even
SonAni_Balance:	dc.b $F, frS_BalanceA1, frS_BalanceA2, frS_BalanceA3, afEnd
		even
SonAni_LookUp:	dc.b 5, frS_Look1, frS_Look2, afBack, 1
		even
SonAni_Duck:	dc.b 5, frS_Duck1, frS_Duck2, afBack, 1
		even
SonAni_Spindash:	dc.b 1, frS_SpDsh1, frS_SpDsh2, frS_SpDsh3, frS_SpDsh4, frS_SpDsh5, frS_SpDsh6, afEnd
		even
...
id_dash:equ (ptr_Debut-Ani_Sonic)/2		; $23
id_warp3:equ (ptr_Debut-Ani_Sonic)/2		; $23
id_jump:equ (ptr_Debut-Ani_Sonic)/2		; $23
