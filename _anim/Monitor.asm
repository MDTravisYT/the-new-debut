...
Ani_Monitor:	dc.w @static-Ani_Monitor, @eggman-Ani_Monitor, @sonic-Ani_Monitor
		...
		dc.w @breaking-Ani_Monitor,	@cycle-Ani_Monitor
...
@breaking:	dc.b 2,	0, 1, 2, $B, afBack, 1
		even
@cycle:	dc.b 3,	0, $3, $3, $3, $3, $3, $3, $3, $3, 1, $4, $4, $4, $4, $4, $4, $4, $4, 2, $5, $5, $5, $5, $5, $5, $5, $5, 0, $6, $6, $6, $6, $6, $6, $6, $6, 1, $7, $7, $7, $7, $7, $7, $7, $7, 2, $8, $8, $8, $8, $8, $8, $8, $8, 0, $9, $9, $9, $9, $9, $9, $9, $9, 1, $A, $A, $A, $A, $A, $A, $A, $A, afEnd
		even