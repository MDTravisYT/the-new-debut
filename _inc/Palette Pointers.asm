...
ptr_Pal_IMZ:		palp	Pal_IMZ,v_pal_dry+$20,$30		
...
palid_IMZ:		equ (ptr_Pal_IMZ-PalPointers)/8
palid_SLZ:		equ (ptr_Pal_SLZ-PalPointers)/8
palid_SZ:		equ (ptr_Pal_SYZ-PalPointers)/8
palid_CWZ1:		equ (ptr_Pal_SBZ1-PalPointers)/8
palid_Special:		equ (ptr_Pal_Special-PalPointers)/8
palid_LZWater:		equ (ptr_Pal_LZWater-PalPointers)/8
palid_CWZ3:		equ (ptr_Pal_SBZ3-PalPointers)/8
palid_CWZ3Water:	equ (ptr_Pal_SBZ3Water-PalPointers)/8
palid_CWZ2:		equ (ptr_Pal_SBZ2-PalPointers)/8
palid_LZSonWater:	equ (ptr_Pal_LZSonWater-PalPointers)/8
palid_CWZ3SonWat:	equ (ptr_Pal_SBZ3SonWat-PalPointers)/8
