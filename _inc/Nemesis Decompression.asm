...
_ChkEnd:
    ...
    bne.s   _NewPalIndex        ; if not, branch
    rts
; ---------------------------------------------------------------------------
...
_ItemLoop:
    ...
    bne.s   _ItemShortCode      ; if not, a bit of extra processing is needed
    move.b  (a0)+,d0        ; get code
    add.w   d0,d0           ; each code gets a word-sized entry in the table
    move.w  d7,(a1,d0.w)        ; store the entry for the code
    bra.s   _ItemLoop       ; repeat
; ---------------------------------------------------------------------------
...
_ItemShortCodeLoop:
    ...
    dbf d5,_ItemShortCodeLoop   ; repeat for required number of entries
    bra.s   _ItemLoop