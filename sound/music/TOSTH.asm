...
smpsHeaderStartSong = 1
	...
	smpsHeaderFM        Mus8B_Ending_FM1,	$F4, $0E ;E
	smpsHeaderFM        Mus8B_Ending_FM2,	$F4, $09 ;9
	smpsHeaderFM        Mus8B_Ending_FM3,	$F4, $0D ;D
	smpsHeaderFM        Mus8B_Ending_FM4,	$F4, $0D ;D
	smpsHeaderFM        Mus8B_Ending_FM5,	$F4, $17 ;17
	smpsHeaderPSG       Mus8B_Ending_PSG1,	$D0, $05, $00, fTone_05 ; 5
	smpsHeaderPSG       Mus8B_Ending_PSG2,	$DC, $05, $00, fTone_05 ; 5
	smpsHeaderPSG       Mus8B_Ending_PSG3,	$00, $03, $00, fTone_04 ; 3
...
Mus8B_Ending_FM1:
	...
	dc.b	nRst, $60
	smpsAlterVol        $FB
	dc.b	nRst, $0C, nRst, $06, nRst, nRst, $0C, nRst, $06, nRst, nRst, $18
	dc.b	nRst, $18, nRst
	dc.b	nRst, $48
;	smpsAlterVol        $FB
...
Mus8B_Ending_Loop03:
	...
	dc.b	nRst, nF3, nRst, nFs3, nRst, nA3, nRst, nE3, nRst
	dc.b	nG3, nRst, nE3, nRst, nA3, nA3, nE3, nRst, nA3, nRst, nAb3, nRst
	dc.b	nG3, $06, nRst, nE3, nRst, nF3, nRst, nFs3, nRst, nG3, nG3, nE3
	...
	smpsLoop            $00, $01, Mus8B_Ending_Loop03
	smpsAlterVol        $FD
	dc.b	nA2, $6C
	smpsNop             $01
	smpsStop
...
Mus8B_Ending_Loop02:
	...
	dc.b	$0C, nRst, nE6, $0C, nFs6, nE6, nFs6, $12, nE6, $1E
	dc.b	nRst, $0C, nD6, $12, nRst, $06, nD6, nRst, nCs6, $12, nD6, nCs6
...
; PSG1 Data
Mus8B_Ending_PSG1:
	dc.b	nRst, $6C, nRst, nRst, nRst, nRst, $0C, nB5, $12, nRst, $06
	dc.b	nB5, nRst, nA5, $12, nB5, nA5, $0C, nRst, nCs6, nD6, nCs6, nD6, $12
	dc.b	nCs6, $1E, nRst, $0C, nB5, $12, nRst, $06
...
Mus8B_Ending_PSG2:
	smpsAlterNote       $01
	dc.b	nRst, $58, nRst, nRst, nRst, nRst, nRst, nRst, $0C, nRst
	dc.b	$06, nRst, nRst, $0C, nRst, $06, nRst, nRst, $18, nRst, $18, nRst
	dc.b	nRst, nRst, nRst, nRst, $0C, nCs6, $06, nRst
	dc.b	nB6, nE6, nRst, $0C, nE6, $06, nRst, nB6, nE6, nRst, $18
	smpsStop
	
;	dc.b	nRst, $58, nRst, nRst, nRst, nRst, nRst, nRst, $0C, nE6
;	dc.b	$06, nRst, nCs6, $0C, nD6, $06, nRst, nCs6, $18, nD6, $18, nRst
...
Mus8B_Ending_Loop04:
	...
	smpsNoteFill        $0C
	dc.b	$0C
	smpsLoop            $00, $11, Mus8B_Ending_Loop04
	smpsNoteFill        $03
	dc.b	$06
	smpsNoteFill        $0E
	dc.b	$12
...
; DAC Data
Mus8B_Ending_DAC:
	dc.b	nRst, $0C, dSnare, dSnare, dSnare
...
Mus8B_Ending_Loop00:
	...
	smpsLoop            $00, $04, Mus8B_Ending_Loop00
