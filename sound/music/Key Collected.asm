...
smpsHeaderStartSong = 1
	...
	smpsHeaderFM        Mus91_Sonic_Got_Through_FM1,	$F5, $0A
	smpsHeaderFM        Mus91_Sonic_Got_Through_FM2,	$DD, $0A
	smpsHeaderFM        Mus91_Sonic_Got_Through_FM3,	$F5, $15
	smpsHeaderFM        Mus91_Sonic_Got_Through_FM4,	$F5, $15
	smpsHeaderFM        Mus91_Sonic_Got_Through_FM5,	$F5, $14
	smpsHeaderPSG       Mus91_Sonic_Got_Through_PSG1,	$D1, $05, $00, fTone_05
	smpsHeaderPSG       Mus91_Sonic_Got_Through_PSG2,	$DD, $07, $00, fTone_05
	smpsHeaderPSG       Mus91_Sonic_Got_Through_PSG3,	$DD, $00, $00, fTone_04
...
Mus91_Sonic_Got_Through_PSG1:
	dc.b	nF4, $06, nG4, nA4, nB4, nC5, nD5, $06
	smpsStop
...
Mus91_Sonic_Got_Through_FM2:
	...
	smpsNoteFill        $0B
	smpsNop             $01
	dc.b	nG5, $03, nG5, nG4, $06, nG4, nG5, $03, nG5, nG4, $06, nG4, $06
	smpsStop
...
Mus91_Sonic_Got_Through_FM3:
	...
	smpsSetvoice        $02
	smpsNoteFill        $06
	dc.b	nC6, $03, nC6, nRst, $0C, nC6, $03, nC6, $06, nRst
	smpsStop
...
Mus91_Sonic_Got_Through_FM4:
	...
	smpsSetvoice        $02
	smpsNoteFill        $06
	dc.b	nA5, $03, nA5, nRst, $0C, nA5, $03, nA5, $06, nRst
	smpsStop

; FM5 Data
Mus91_Sonic_Got_Through_FM5:
	smpsSetvoice        $03
	smpsModSet          $0D, $01, $02, $05

; PSG2 Data
Mus91_Sonic_Got_Through_PSG2:
	dc.b	nG5, $06, nC6, nB5, nG5, nC6, nB5, $06
