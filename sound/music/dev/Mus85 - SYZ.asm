...
smpsHeaderStartSong = 1
	...
	smpsHeaderFM        Mus85_SYZ_FM1,	$F5, $11
	smpsHeaderFM        Mus85_SYZ_FM2,	$E9, $0B
	smpsHeaderFM        Mus85_SYZ_FM3,	$F5, $7F
	smpsHeaderFM        Mus85_SYZ_FM4,	$F5, $18
	smpsHeaderFM        Mus85_SYZ_FM5,	$F5, $18
	smpsHeaderPSG       Mus85_SYZ_PSG1,	$69, $0A, $00, fTone_07
	smpsHeaderPSG       Mus85_SYZ_PSG2,	$81, $07, $00, $00
	smpsHeaderPSG       Mus85_SYZ_PSG3,	$00, $7E, $00, fTone_04
...
;	smpsAlterVol        $08
	...
	dc.b	$02, nRst, $2A, nRst, $04
;	smpsAlterVol        $F8
	smpsJump            Mus85_SYZ_Jump02

Mus85_SYZ_Call08:
	dc.b	nE6,  $02, nRst, $04, nE6,  $08, nC6, $02, nRst, $04
	dc.b	nA5,  $02, nRst, $04, nE6,  $0C, nC6, $0A, nRst, $2C
	dc.b	nFs6, $02, nRst, $04, nFs6, $08, nD6, $02, nRst, $04
	dc.b	nB5,  $02, nRst, $04, nFs6, $0C
	smpsReturn
...
Mus85_SYZ_Loop04:
    ...
    dc.b nA4, nRst, $02, nBb4
    smpsLoop            $00, $02, Mus85_SYZ_Loop04
    smpsCall            Mus85_SYZ_Call07
    dc.b nF4, nRst, $02, nE4, nRst, $04, smpsNoAttack, nE4, $08, nE4, $03, nRst
    dc.b nE4, nRst, nA4, $09, nRst, $03, nA4, $0A, nD4, $02, nRst, $2E 
     dc.b nD4, $02
    smpsNop             $01
...
Mus85_SYZ_Call07:
    ...
    dc.b    nRst, nG4, nRst, nF4, nRst, nF4, nRst, nG4, $04
    smpsReturn
...
Mus85_SYZ_Loop00:
	...
	dc.b	dKick, $04, dKick, $08, dSnare, $06, dKick, dKick, $06, dSnare, dSnare, dSnare
	dc.b	$04, dKick, $02

Mus85_SYZ_Loop01:
	smpsCall            Mus85_SYZ_Call00
	smpsLoop            $00, $02, Mus85_SYZ_Loop01
	dc.b	dKick, $04, dKick, $08, dSnare, $06, dKick, dKick, $0C, dSnare, dSnare, $06
...
Mus85_SYZ_Call00:
	dc.b	dKick, $04, dKick, $08, dSnare, $06, dKick, dKick, $0C, dSnare, $0A, dKick
	dc.b	$02
	smpsReturn
