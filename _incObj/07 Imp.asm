...
; ===========================================================================
; Constants -----------------------
Bigjaw_JumpRadius:      equ     $5A
; Vars and Flags ------------------
Bigjaw_Jumptimer:       equ     $32
; Jumptable IDs -------------------
ID_Imp_Main:		equ 	$0
ID_Imp_Action:		equ 	$2
...
Imp_Main:	; Routine $0 (ID_Imp_Main)
		...
		move.b  #0,Bigjaw_Jumptimer(a0)
		rts
; ===========================================================================
; Makes Bigjaw move
; ===========================================================================
Imp_Action:	; Routine $2 (ID_Imp_Action)
                move.b	#ID_Imp_ChkSonic,obRoutine(a0)
...
Imp_Jump:	; Routine $6 (ID_Imp_Jump)
		...
		move.b	#ID_Imp_Action,obRoutine(a0)
		move.b  #50,Bigjaw_Jumptimer(a0)
		tst.w   ObVelY(a0)
		bmi.s   @skip
		sfx     $BB,0,0,0
@skip:
