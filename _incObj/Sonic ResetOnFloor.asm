...
loc_137E4:
		...
		beq.s	@ret
		cmpi.b	#id_Mighity,(v_character).w ; Are we Mighty?
	...
	@notmighty:
		cmpi.b	#id_Sonic,(v_character).w
		bne.s	@notsonic
		cmpi.b	#4,obDoubleJump(a0) ; Really only matters for Sonic
		beq.s	@ret
		cmpi.b	#8,(v_shield).w		; Does Sonic have the bubble Shield?
