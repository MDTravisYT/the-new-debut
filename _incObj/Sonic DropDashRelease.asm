Sonic_ReleaseDropDash:	; d0 is dash, d1 is max, d2 is x vel, d3 is inertia, and... d4 is v_jpadpress1
		...
		cmpi.b  #id_DropDash,obAnim(a0)   ; (lava) check for preventing a bug when you can uhh do drop dash even when you hit the ground from a spring 
                beq.w	@IGnoreAndClear  ; if we are not in drop dash anim then dont do drop dash (branch)
